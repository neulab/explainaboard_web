...
const login = () => {
  window.location.href = encodeURI(
    `https://explainaboard-dev.auth.us-east-1.amazoncognito.com/oauth2/authorize?client_id=321jpah4jmcdqha7gb9pf9vnqv&response_type=token&scope=email+openid+phone&redirect_uri=${window.location.href}`
  );
};
